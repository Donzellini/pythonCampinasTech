...
while True:
    ...
    if opcao_selecionada == 0: #Sai do programa
        ...
        while True:
            ...
            professor = Professor(nome=nome_professor,documento=documento_professor,matricula=matricula_professor) #Incluindo o documento no momento do construtor
            lista_professores.append(professor) #Insere um professor na lista
            print(f"O professor {professor.nome} foi inserido!")  #Mostra para o usuário que o append, no caso o professor, foi feito      
